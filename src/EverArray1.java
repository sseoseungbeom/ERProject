...
public class EverArray1 {

	public  ArrayList<String> saveTicket = new ArrayList<String>();
	public  ArrayList<String>savePeople =new ArrayList<String>();
	public  ArrayList<Integer> saveNum = new ArrayList<Integer>();
	public  ArrayList<Integer> saveTotalPrice = new ArrayList<Integer>();
	public  ArrayList<String> saveMemo = new ArrayList<String>();
	...
	case 5:
		...
		public void reservationDate() { //날짜
	...
	*/
	...
	public void ArrayAdd(String ticket, String people, int number, int totalPrice, String memo) {
		saveTicket.add(ticket);
		savePeople.add(people);
		saveNum.add(number);
		saveTotalPrice.add(totalPrice);
