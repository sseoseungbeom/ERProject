...
public class EverlandProject3_MODI {

	public static void main(String[] args) {

		int addOrder =0; int orderCount =0;
		int [] saveReservationDate = new int [100];
		String [] saveTicket = new String[100];
		String [] savePeople = new String[100];
		int [] saveNum = new int[100];
		int [] saveTotalPrice = new int [100];
		String [] saveMemo = new String[100];
			...
			switch(choice) {
				...
				case 1:
					...
					do {
						...
						addOrder = sc.nextInt();
						saveReservationDate[orderCount]=reservationDate;
						saveTicket[orderCount] = ticket;
						savePeople[orderCount] = people;
						saveNum[orderCount]= num;
						saveTotalPrice[orderCount] = totalPrice;
						saveMemo[orderCount] = memo;
						orderCount++;
					...
					for(int index=0; index < orderCount; index++) {
						System.out.printf("%d %s %s X %d %d 원   %s  \n",saveReservationDate[index], saveTicket[index], savePeople[index],saveNum[index], saveTotalPrice[index], saveMemo[index]);
					} // for 종료
					System.out.println("========================");
